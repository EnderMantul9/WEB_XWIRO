    ...
    <section className="relative pt-32 pb-20 overflow-hidden min-h-[600px] flex items-center">
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="max-w-3xl">
          ...
          <div className="relative max-w-2xl animate-in fade-in slide-in-from-bottom-12 duration-700 delay-200">
            ...
            <div className="absolute right-2 top-1/2 -translate-y-1/2">
              <button className="bg-primary text-white px-8 py-3 rounded-full font-semibold hover:bg-primary/90 transition-all hover:scale-105">
                Cari
              </button>
            </div>
          </div>
