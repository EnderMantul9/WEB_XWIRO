...
import { Suspense } from 'react'; // <-- Ditambahkan untuk membungkus komponen dinamis
...
// 1. Komponen Internal yang mengurusi logika pencarian
...
// 2. Fungsi Ekspor Utama Halaman (Default Export)
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      <div className="container mx-auto px-4 pt-40 pb-20">
        {/* Membungkus logika search dengan Suspense agar aman saat diproses Vercel */}
        <Suspense fallback={
